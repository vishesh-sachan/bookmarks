...
import { filesAtom, foldersAtom, updatedFilesAtom, updatedFoldersAtom } from "@/store/atoms";
...
export default function Root() {
    ...
    const [updatedFolers , setUpdatedFolders] = useRecoilState(updatedFoldersAtom)
    const [showFolderModal , setShowFolderModal] = useState(false)
    const [showFileModal , setShowFileModal] = useState(false)

    useEffect(()=>{
        async function getFolders(){
            // console.log("folders get called")
            try{
    ...
    async function addFolder(e:any) {
                ...
                <form onSubmit={addFolder}>
                    <div className="h-screen flex items-center justify-center ">
                        <div className="border rounded font-SFmono text-[#FFFFFF] bg-[#1E1E1E] bg-opacity-80">
                            ...
                            <div className="bg-[#FFFFFF] py-3 px-5 m-50 rounded text-[#000000] bg-[#0084FF] cursor-pointer">
                                <button type="submit">
                                    Done
                                </button>
                            </div>
