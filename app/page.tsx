...
export default function Home() {
  ...
  return (
    <main>
      ...
      <div className="flex justify-center font-SFmono text-5xl md:text-6xl text-[#FFFFFF] mt-230">BookMarks Manager</div>
      <div className="flex justify-center font-SFmono text-2xl text-[#FFFFFF] mt-10">Keep your Links Handy</div>
      <div className="flex justify-center font-SFmono text-lg lg:text-xl xl:text-2xl text-[#999999] mt-230">Why Need It? Because Arc Browser Does't Have It!</div>
